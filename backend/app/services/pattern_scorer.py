...
def _recency_weight(created_at: Optional[datetime]) -> float:
    """Return a negative score adjustment for recent patterns.
...
def score_patterns(
    ...
    *,
    ...
    """Re-rank *patterns* from RAGService.find_similar_patterns.
    ...
    for p in patterns:
        ...
        final = max(0.0, base + adjustment)  # clamp to [0, inf)
